...
import com.godlikexyj.common.annotation.ForeignKeyField;
import com.godlikexyj.common.constant.Constant;
import com.godlikexyj.common.dao.BaseDao;
import com.godlikexyj.common.entity.BaseEntity;
...
public class ForeignKeyAspect {
    ...
    @Before(value = "@annotation(com.godlikexyj.common.annotation.ForeignKey)")
    ...
    @AfterReturning(returning = "result", pointcut = "@annotation(com.godlikexyj.common.annotation.ForeignKey)")
